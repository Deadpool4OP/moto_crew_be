...
const createRoom = catchAsync(async (req: any, res: any) => {
...
const joinRoom = catchAsync(async (req: any, res: any) => {
...
const leaveRoom = catchAsync(async (req: any, res: any) => {
...
const getRoom = catchAsync(async (req: any, res: any) => {
...
const getRiders = catchAsync(async (req: any, res: any) => {
  const room = await roomService.getRoomById(req.params.roomId);
  if (!room) {
    throw new ApiError(httpStatus.NOT_FOUND, 'Room not found');
  }
...
const closeRoom = catchAsync(async (req: any, res: any) => {
...
const getMyRooms = catchAsync(async (req: any, res: any) => {
...
const getRideHistory = catchAsync(async (req: any, res: any) => {
